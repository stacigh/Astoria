<?php 
	/*
		Template Name: Audio Category Template
	*/
?>
...
<div id="wrapper-body" class="container_16">
	<div id="wrapper-article" class="grid_12">
        ...
        <p>We broadcast every Saturday at 4am, 8am, 12pm, 4pm, 8pm and 12am EST at 7:45pm on Radio Pan Am. To listen to our archived broadcasts, press the play button on each archive page. To listen to an entire series, or specific parts of the series, you can toggle the playlist by clicking on the playlist icon below the player.</p>
        <?php echo do_shortcode('[mp3j track="01-Overview.mp3"]'); ?>
        <br />
        </div>
			...
			<?php query_posts($query_string . "&order=ASC"); while (have_posts()) : the_post(); ?>
				...
				<div id="archives" <?php post_class() ?>>
					...
					<?php the_excerpt(); ?>
                    <a href="<?php the_permalink(); ?>" class="button-blue"><span>Explore this Series</span></a>
